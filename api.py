...
if __name__ == "__main__":
    uvicorn.run(app, host="0.0.0.0", port=8000, ssl_keyfile="/etc/letsencrypt/live/banglallm.rashik.sh/fullchain.pem", ssl_certfile="/etc/letsencrypt/live/banglallm.rashik.sh/privkey.pem")
